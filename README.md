...
Landscape visualization from landcover maps generated by the [LCC.net](https://github.com/bneukom/LCC.net) tool. The goal of this viualization is to show that low resultion global satellite imagery which is freely available can be used to improve landscape visualizations. <b>Note</b> that "Download ZIP" does not work for this project as the sample scene is stored using GIT LFS. 
